...
let mockApartments: [Apartment] = [
    Apartment(
        ...
        coordinate: CLLocationCoordinate2D(latitude: 12.911290, longitude: 100.862720),
    ...
    Apartment(
        ...
        coordinate: CLLocationCoordinate2D(latitude: 12.911851, longitude: 100.861946),
        address: "Pratumnak 6",
        area: 40,
        floor: 3,
        status: .available
    ...
    Apartment(
        ...
        coordinate: CLLocationCoordinate2D(latitude: 12.886407, longitude: 100.878556),
